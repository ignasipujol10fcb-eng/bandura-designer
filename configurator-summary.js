...
(() => {
  ...
  const labels = {
    en: 'Your design', es: 'Tu diseño', uk: 'Ваш дизайн', it: 'Il tuo design', fr: 'Votre design',
    de: 'Ihr Design', zh: '您的设计', ja: 'あなたのデザイン', he: 'העיצוב שלך'
  };
  const hint = {
    en: 'Selections are saved on this device.', es: 'Las elecciones se guardan en este dispositivo.', uk: 'Вибір зберігається на цьому пристрої.',
    it: 'Le scelte vengono salvate su questo dispositivo.', fr: 'Vos choix sont enregistrés sur cet appareil.', de: 'Ihre Auswahl wird auf diesem Gerät gespeichert.',
    zh: '选择会保存在此设备上。', ja: '選択内容はこのデバイスに保存されます。', he: 'הבחירות נשמרות במכשיר הזה.'
  };
  ...
  /* Expose the existing immutable configurator data without duplicating it. */
