...
(() => {
  ...
  const addPerformancePhoto = () => {
    ...
    style.textContent = `.gallery-card.detail{isolation:isolate}.gallery-performance-photo{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;opacity:.72;filter:saturate(.78) contrast(1.06);transition:opacity .45s,transform .7s;z-index:-2}.gallery-card.detail:before{content:'';position:absolute;inset:0;background:linear-gradient(180deg,#17130f2b 0%,#17130f66 55%,#17130fd9 100%);z-index:-1;pointer-events:none}.gallery-card.detail:hover .gallery-performance-photo{opacity:.84;transform:scale(1.025)}.gallery-photo-credit{position:absolute;right:20px;bottom:20px;max-width:58%;color:#f5eee1b8;font-size:7px;line-height:1.4;letter-spacing:.08em;text-align:right;z-index:3}@media(max-width:900px){.gallery-photo-credit{right:14px;bottom:14px;max-width:68%;font-size:6px}}@media(prefers-reduced-motion:reduce){.gallery-performance-photo{transition:none}}`;
